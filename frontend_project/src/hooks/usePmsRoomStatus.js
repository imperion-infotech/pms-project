...
export const usePmsRoomStatus = () => {
  ...
  const addRoomStatus = useCallback(async (payload) => {
    try {
  ...
  const updateRoomStatus = useCallback(async (id, payload) => {
    try {
  ...
  const deleteRoomStatus = useCallback(async (id) => {
    try {
  ...
  return { roomStatuses, isLoading, fetchRoomStatuses, addRoomStatus, updateRoomStatus, deleteRoomStatus, searchRoomStatuses }
}
