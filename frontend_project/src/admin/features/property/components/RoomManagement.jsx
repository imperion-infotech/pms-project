...
const RoomManagement = ({ rooms = [], roomTypes = [], floors = [], setIsRoomModalOpen, onEdit, onDelete }) => {
      ...
      <div className="w-full overflow-x-auto custom-scrollbar">
        <table className="w-full text-left border-collapse min-w-[1400px]">
          ...
          <tbody className="text-[13px] divide-y divide-slate-100 dark:divide-slate-800">
            {rooms.length === 0 ? (
              <tr>
                <td colSpan="9" className="px-6 py-10 text-center text-slate-400 dark:text-slate-500 italic">No rooms available. Add your first room.</td>
              </tr>
            ) : rooms.map((room) => {
